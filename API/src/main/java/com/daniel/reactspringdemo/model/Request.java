package com.daniel.reactspringdemo.model;
...
public class Request {
    ...
    public String toString() {
        return "Request [id=" + id + ", requester=" + requester + ", date=" + date + ", reason=" + reason + "state=" + approved + "duration=" + duration + "rejected=" + rejected + "]";
    }
}
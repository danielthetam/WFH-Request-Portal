...
function AdminView() {
    ...
    const approveClicked = async (id) => {
        const request = await axios.get("http://localhost:8080/api/requests/" + id.toString())
        const requestData = request.data;
        await axios.put("http://localhost:8080/api/requests/" + id.toString(), {
    ...
    const deleteClicked = async (id) => {
        await axios.delete("http://localhost:8080/api/requests/" + id.toString())
        getRequests()
    }

    const getRequests = async () => {
        const request = await axios.get('http://localhost:8080/api/requests' + sorting)
...
// TODO three sorting types based on states, unreviewed, approved, and rejected. 
// State should show N/A if both bools are false, meaning it's unreviewed